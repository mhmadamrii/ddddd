...
import { GraduationCap, Users, BookOpen, Clock, UserPlus, BookPlus } from "lucide-react"
...
import { RecentStudents } from "@/app/(dashboard)/dashboard/components/recent-students"

export default function DashboardPage() {
  return (
    <>
      <DashboardShell>
        <DashboardHeader heading="Dashboard" text="Overview of your institution">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
          <Card className="col-span-4">
            <CardHeader>
              ...
              <CardDescription>Student enrollment trends over the past academic year</CardDescription>
            </CardHeader>
          ...
          <Card className="col-span-3">
            <CardHeader>
              ...
              <CardDescription>Recently added students to your institution</CardDescription>
            </CardHeader>
            <CardContent>
              <RecentStudents />
            </CardContent>
